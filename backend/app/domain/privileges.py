...
APPLICABILITY: dict[str, tuple[str, ...]] = {
    ...
    "READ_VOLUME": ("CATALOG", "SCHEMA", "VOLUME"),
    "WRITE_VOLUME": ("CATALOG", "SCHEMA", "VOLUME"),
    "CREATE_CATALOG": ("METASTORE",),
    "CREATE_CONNECTION": ("METASTORE",),
    "CREATE_CLEAN_ROOM": ("METASTORE",),
    "CREATE_EXTERNAL_LOCATION": ("METASTORE", "STORAGE_CREDENTIAL"),
    "CREATE_EXTERNAL_TABLE": ("EXTERNAL_LOCATION", "STORAGE_CREDENTIAL"),
    "CREATE_EXTERNAL_VOLUME": ("EXTERNAL_LOCATION",),
    "CREATE_FOREIGN_CATALOG": ("CONNECTION",),
    "CREATE_FOREIGN_SECURABLE": ("CONNECTION",),
    "CREATE_FUNCTION": ("CATALOG", "SCHEMA"),
    "CREATE_MANAGED_STORAGE": ("EXTERNAL_LOCATION",),
    "CREATE_MATERIALIZED_VIEW": ("CATALOG", "SCHEMA"),
    "CREATE_MODEL": ("CATALOG", "SCHEMA"),
    "CREATE_PROVIDER": ("METASTORE",),
    "CREATE_RECIPIENT": ("METASTORE",),
    "CREATE_SCHEMA": ("CATALOG",),
    "CREATE_SERVICE_CREDENTIAL": ("METASTORE",),
    "CREATE_SHARE": ("METASTORE",),
    "CREATE_STORAGE_CREDENTIAL": ("METASTORE",),
    "CREATE_TABLE": ("CATALOG", "SCHEMA"),
    "CREATE_VIEW": ("CATALOG", "SCHEMA"),
    "CREATE_VOLUME": ("CATALOG", "SCHEMA"),
    "EXTERNAL_USE_LOCATION": ("EXTERNAL_LOCATION",),
    "EXTERNAL_USE_SCHEMA": ("SCHEMA",),
    ...
    "READ_METADATA": ("METASTORE",),
    "REFRESH": CHILDREN,
    "SET_SHARE_PERMISSION": ("METASTORE", "SHARE"),
    "USE_CONNECTION": ("CONNECTION",),
    "USE_MARKETPLACE_ASSETS": ("METASTORE",),
    "USE_PROVIDER": ("METASTORE", "PROVIDER"),
    "USE_RECIPIENT": ("METASTORE", "RECIPIENT"),
...
DESCRIPTIONS = {
    "ALL_PRIVILEGES": (
        "All applicable privileges evaluated by Unity Catalog at use time. This is not every "
        "administrative privilege: it does not include MANAGE, EXTERNAL_USE_SCHEMA, or "
    ...
    "USE_CATALOG": (
        "Use this catalog as a parent prerequisite; this alone does not grant data access."
    ),
...
def catalogue(codes: Iterable[str], securable_type: str | None = None) -> tuple[Privilege, ...]:
    ...
    for code in sorted(set(codes)):
        ...
        if not targets:
            description = (
                "SDK privilege code retained for completeness. Applicability to this API is "
                "unverified; it is not offered for grants."
            )
        values.append(
            Privilege(
                code=code,
                ...
                category=category,
                securable_types=tuple(SecurableType(t) for t in targets),
