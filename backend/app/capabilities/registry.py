...
REGISTRY = (
    ...
    Declaration("assets.read", "7.1"),
    Declaration("assets.edit_metadata", "7.1"),
    Declaration("assets.delete", "7.1"),
    Declaration("grants.read", "7.2"),
    Declaration("grants.update", "7.2"),
    Declaration("ownership.transfer", "7.2"),
    Declaration("principals.search", "7.2"),
    Declaration("privileges.read", "7.2"),
    Declaration("tags.read", "7.3", SQL),
    Declaration("tags.update", "7.3"),
    Declaration("tag_policies.read", "7.3"),
