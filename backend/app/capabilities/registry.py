...
REGISTRY = (
    ...
    Declaration("filters.update", "7.5", SQL, status=AVAILABLE),
    Declaration("dynamic_views.update", "7.5", SQL),
    Declaration("storage_credentials.read", "7.6", status=AVAILABLE),
    Declaration(
        "storage_credentials.create",
        "7.6",
        reason="The frozen contract has no storage-credential create route or plan kind.",
    ),
    Declaration(
        "storage_credentials.update",
        "7.6",
        reason="The frozen contract has no storage-credential update route or plan kind.",
    ),
    Declaration(
        "storage_credentials.delete",
        "7.6",
        reason="The frozen contract has no storage-credential delete route or plan kind.",
    ),
    Declaration(
        "storage_credentials.validate",
        "7.6",
        reason="The frozen contract has no storage-credential validation route or plan kind.",
    ),
    Declaration(
        "service_credentials.read",
        "7.6",
        reason="The frozen contract has no service-credentials route.",
    ),
    Declaration(
        "service_credentials.update",
        "7.6",
        reason="The frozen contract has no service-credentials route or plan kind.",
    ),
    Declaration("external_locations.read", "7.6", status=AVAILABLE),
    Declaration(
        "external_locations.create",
        "7.6",
        reason="The frozen contract has no external-location create route or plan kind.",
    ),
    Declaration(
        "external_locations.update",
        "7.6",
        reason="The frozen contract has no external-location update route or plan kind.",
    ),
    Declaration(
        "external_locations.delete",
        "7.6",
        reason="The frozen contract has no external-location delete route or plan kind.",
    ),
    Declaration(
        "external_locations.validate",
        "7.6",
        reason="The frozen contract has no external-location validation route or plan kind.",
    ),
